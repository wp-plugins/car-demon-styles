...
if ($is_it_iis == 'Apache') {
	$newPath = str_replace('wp-content/plugins/car-demon-styles/theme-files/guy', '', $newPath);
	include_once($newPath."/wp-load.php");
	include_once($newPath."/wp-includes/wp-db.php");
}
else {
	$newPath = str_replace('wp-content\plugins\car-demon-styles\theme-files\guy', '', $newPath);
	include_once($newPath."\wp-load.php");
	include_once($newPath."\wp-includes/wp-db.php");
}

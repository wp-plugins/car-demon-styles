...
wp_enqueue_script('guy-style-js', WP_CONTENT_URL . '/plugins/car-demon-styles/theme-files/guy/guy_js.php');
wp_enqueue_style('guy-style-single-car-css', WP_CONTENT_URL . '/plugins/car-demon-styles/theme-files/guy/guy-style-single-car.css');
get_header();
include('guy-style-include.php');
	...
	foreach($thumbnails as $thumbnail) {
		...
		if($pos == true) {
			if ($cnt < $stop) {
				...
				$photo_array = '<img class="guy_thumbs" style="cursor:pointer" onClick=\'MM_swapImage("'.$car_title.'_pic","","'.trim($thumbnail).'",1);active_img('.$cnt.');\' src="'.trim($thumbnail).'" width="53" />';
				$this_car .= $photo_array;
				$cnt = $cnt + 1;
			}
		}
...
<div class="guy_car_body" id="tab1">
	<div class="photos">
    ...
    <div class="car_description">
		...
		<div class="price">
			<?php echo get_vehicle_price_style_guy($post_id); ?>
		</div>
	</div>

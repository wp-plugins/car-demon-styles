...
wp_enqueue_style('ccp-style-single-car-css', WP_CONTENT_URL . '/plugins/car-demon-styles/theme-files/cyberchimps_pro/ccp-style-single-car.css');
wp_enqueue_style('ccp-style-single-car-contact-css', WP_CONTENT_URL . '/plugins/car-demon/forms/css/car-demon-contact-us.css');
...
<div id="single_page" class="container-full-width">
 ...
 <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div id="sidebar-right" class="widget-area span3">
            <ul>
